...
func (s *SearchIndex) InsertSearchEntry(ctx context.Context, kind uint32, searchType SearchType, tagValue []byte, createdAt uint64, loc types.RecordLocation) error {
...
func (s *SearchIndex) RangeSearch(ctx context.Context, kind uint32, searchType SearchType, tagValuePrefix []byte, desc bool) (Iterator, error) {
